  ...
  <div class="row">
    <div class="col-md-3 col-sm-6">
      ...
      <div class="img-box-4-item">
        <!-- Image -->
        <a href="img/gallery/small/1.jpg" class="lightbox"><img src="<?php echo get_template_directory_uri(); ?>/img/gallery/small/1.jpg" alt="" class="img-responsive" /></a>
        <!-- Image Box #4 Content -->
    ...
    <div class="col-md-3 col-sm-6">
      <div class="img-box-4-item">
        <a href="img/gallery/small/2.jpg" class="lightbox"><img src="<?php echo get_template_directory_uri(); ?>/img/gallery/small/2.jpg" alt="" class="img-responsive" /></a>
        <div class="img-box-4-content">
    ...
    <div class="col-md-3 col-sm-6">
      <div class="img-box-4-item">
        <a href="img/gallery/small/3.jpg" class="lightbox"><img src="<?php echo get_template_directory_uri(); ?>/img/gallery/small/3.jpg" alt="" class="img-responsive" /></a>
        <div class="img-box-4-content">
    ...
    <div class="img-box-4-item">
      <a href="img/gallery/small/4.jpg" class="lightbox"><img src="<?php echo get_template_directory_uri(); ?>/img/gallery/small/4.jpg" alt="" class="img-responsive" /></a>
      <div class="img-box-4-content">
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-5 col-sm-6 text-center">
      <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/rev-slider/mockup1.png" alt="" class="img-responsive" /></a>
    </div>
  </div>
  ...
  <div class="client-one">
    <div class="owl-carousel" data-items="5" data-auto-play="true" data-pagination="false" data-single-item="false">
      <!-- Item -->
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-1.png" alt=""  class="img-responsive" /></a>
        <div class="img-hover"></div>
        <h5><a href="#">Variations</a></h5>
      </div>
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-2.png" alt="" class="img-responsive" /></a>
        <div class="img-hover"></div>
        <h5><a href="#">Repetition</a></h5>
      </div>
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-3.png" alt="" class="img-responsive" /></a>
        <div class="img-hover"></div>
        <h5><a href="#">Pleasure</a></h5>
      </div>
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-4.png" alt="" class="img-responsive" /></a>
        <div class="img-hover"></div>
        <h5><a href="#">Molestiae</a></h5>
      </div>
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-5.png" alt=""  class="img-responsive" /></a>
        <div class="img-hover"></div>
        <h5><a href="#">Extremely</a></h5>
      </div>
      <div class="c1-item">
        <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/img/clients/c1-6.png" alt="" class="img-responsive" /></a>
        <div class="img-hover"></div>
